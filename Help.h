...
#define pop_atom 1         // 6 Число популяций атомов
...
#define RR_ 1.0 // 389.8557              // Характерный размер задачи
...
#define R11_ (1.38/RR_)  // 38.0    // Действует! До какой внутренней границы не двигаем ячейки
#define R111_ (1.5/RR_)  // 50.0 
#define R2_ (2.0/RR_)  // 100.0
#define R3_ (5.0/RR_)  // 150.0
#define R4_ (10.0/RR_)  // 600.0
#define R5_ (15.0/RR_)  // 2200.0
//#define Rmax_ (1300.0/RR_)  // 1300.0  // (1300.0)   // Максимальный радиус для Монте-Карло
#define Left_ (-20.0/RR_)  // -1500
