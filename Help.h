...
#define BE 3551.22 // Магнитное поле на единичном радиусе
...
#define R2_ (15.0/RR_)  // 100.0
#define R3_ (35.0/RR_)  // 150.0
#define R4_ (55.0/RR_)  // 600.0
#define R5_ (90.0/RR_)  // 2200.0
//#define Rmax_ (1300.0/RR_)  // 1300.0  // (1300.0)   // Максимальный радиус для Монте-Карло
#define Left_ (-80.0/RR_)  // -1500
