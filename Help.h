...
#define parameter_1 "vers22_1.txt"
//  2) Установить файл сохранения газодинамических параметров
#define parameter_21 "vers23_1.txt"   //  газодинамических параметров
#define parameter_22 "source_vers23_1.txt"   //  источников монте-карло (это и для сохранения, и для скачивания)
//  3) Установить правильный параметр Kn
#define Kn_  0.0001 // 0.4326569808 // 0.4326569808 // 6.0		
//  4) Выбрать алгоритм расчёта (Монте-Карло \ Газовая динамика)
#define parameter_4 false   // Считаем газовую данимику? Если да, то true, если монте-карло, то false
...
#define parameter_7 "stat_do_22_1.txt"

// Поменял начальную сферу вылета и перезярядку для x > 1
#define charge_x_1 false    // Отключить перезярядку при x > 1
#define Rmax_  2.2  // (1450.0/RR_)  // 1800.0  // (1300.0)   // Максимальный радиус для Монте-Карло
