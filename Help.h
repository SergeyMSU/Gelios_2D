...
#define parameter_1 "vers7_5.txt"
...
#define parameter_4 true   // Считаем газовую данимику? Если да, то true, если монте-карло, то false
...
#define parameter_7 "stat_do_--_-.txt"
